...
set replay=".\\replays\\desync\\2025-03-30 23.50.52 03a7ce94\\TempReplay.w3g"
node replayanalyser_high_level.ts %replay% >./replays/replay_high_level.json
node replayanalyser_low_level.ts %replay% >./replays/replay_low_level.json
pause
