...
private function Init takes nothing returns nothing
    ...
    call AddArenaTicket(ITEM_TICKET_3, ITEM_ICE_SHARD)
    call AddArenaTicketUnitType('nmgw', 2)
    call AddArenaTicket(ITEM_TICKET_4, ITEM_GLOVES_OF_SPELL_MASTERY)
    call AddArenaTicketUnitType('nbzk', 2)
    call AddArenaTicket(ITEM_TICKET_5, ITEM_SHAMAN_CLAWS)
    call AddArenaTicketUnitType('nogn', 2)
    call AddArenaTicketUnitType('nogo', 2)
    call AddArenaTicket(ITEM_TICKET_6, ITEM_THUNDERLIZARD_DIAMOND)
    call AddArenaTicketUnitType('nehy', 2)
    call AddArenaTicket(ITEM_TICKET_7, ITEM_SHIELD_OF_HONOR)
    call AddArenaTicketUnitType('nwna', 2)
    call AddArenaTicket(ITEM_TICKET_8, ITEM_SERATHIL)
    call AddArenaTicketUnitType('nsqa', 1)
    call AddArenaTicketUnitType('nsqo', 2)
    call AddArenaTicket(ITEM_TICKET_9, ITEM_STONEMAUL_ARENA_MASTER_BELT)
