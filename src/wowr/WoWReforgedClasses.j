...
private function Init takes nothing returns nothing
    ...
    set CLASS_PRIEST = AddHeroClass('I03C', ABILITY_HEAL, "HEAL_TOOLTIP", ABILITY_INNFER_FIRE, "INNER_FIRE_TOOLTIP", ABILITY_HASTE, "HASTE_TOOLTIP", ABILITY_DISCHARGE, "DISCHARGE_TOOLTIP", ABILITY_CONSECRATION, "CONSECRATION_TOOLTIP", ABILITY_HEALING_WAVE, "HEALING_WAVE_TOOLTIP", ABILITY_SACRED_AURA, "SACRED_AURA_TOOLTIP", ABILITY_MIND_CONTROL, "MIND_CONTROL_TOOLTIP", ABILITY_CLEANSING_FIRE, "CLEANSING_FIRE_TOOLTIP", ABILITY_REVIVE, "REVIVE_TOOLTIP", ABILITY_HOLY_WRATH, "HOLY_WRATH_TOOLTIP")
    set CLASS_PALADIN = AddHeroClass('I04K', ABILITY_HOLY_LIGHT, "HOLY_LIGHT_TOOLTIP", ABILITY_PARRY, "PARRY_TOOLTIP", ABILITY_RIGHTEOUS_FURY, "RIGHTEOUS_FURY_TOOLTIP", ABILITY_DIVINE_SHIELD, "DIVINE_SHIELD_TOOLTIP", ABILITY_HOLY_AURA, "HOLY_AURA_TOOLTIP", ABILITY_HEALING_SPRAY, "HEALING_SPRAY_TOOLTIP", ABILITY_DEVOTION_AURA, "DEVOTION_AURA_TOOLTIP", ABILITY_HOLY_NOVA, "HOLY_NOVA_TOOLTIP", ABILITY_HORN_OF_STORMWIND, "HORN_OF_STORMWIND_TOOLTIP", ABILITY_RAISE_THE_BANNER, "RAISE_THE_BANNER_TOOLTIP", ABILITY_RESURRECTION, "RESURRECTION_TOOLTIP")
    ...
    set CLASS_VIP = AddHeroClass(ITEM_VIP, ABILITY_ATTRIBUTE_BONUS, "ATTRIBUTE_BONUS_TOOLTIP", ABILITY_DAMAGE_BONUS, "DAMAGE_BONUS_TOOLTIP", ABILITY_ARMOR_BONUS, "ARMOR_BONUS_TOOLTIP", ABILITY_ATTACK_SPEED_BONUS, "ATTACK_SPEED_BONUS_TOOLTIP", ABILITY_MOVE_SPEED_BONUS, "MOVE_SPEED_BONUS_TOOLTIP", ABILITY_LIFE_BONUS, "LIFE_BONUS_TOOLTIP", ABILITY_MANA_BONUS, "MANA_BONUS_TOOLTIP", ABILITY_LIFE_REGENERATION, "LIFE_REGENERATION_TOOLTIP", ABILITY_MANA_REGENERATION, "MANA_REGENERATION_TOOLTIP", ABILITY_SIGHT_RANGE_BONUS, "SIGHT_RANGE_BONUS_TOOLTIP", ABILITY_TELEPORTATION, "TELEPORTATION_TOOLTIP")
endfunction
