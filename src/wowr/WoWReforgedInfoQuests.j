...
private function Init takes nothing returns nothing
    ...
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_VISION_ALL"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_NO_VISION"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_CONTROL_ALL"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_NO_CONTROL"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_AI"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_NO_AI"))
    ...
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_VISION"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_UNVISION"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_CONTROL"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_UNCONTROL"))
    ...
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_LOAD_X"))
    ...
    set udg_QuestAI = AddInfoQuest(Format(GetLocalizedStringSafe("IQ_AI_TITLE")).s(GetLocalizedStringSafe("IQ_ENABLED")).result(), GetLocalizedStringSafe("IQ_AI_DESCRIPTION"), "ReplaceableTextures\\WorldEditUI\\Editor-MultipleUnits.blp")
    call AddInfoQuestItem(GetLocalizedStringSafe("IQ_AI_0"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_HELP_AI"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_AI_RESET"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_AI_RESPAWN"))
    call AddInfoQuestItem(GetLocalizedStringSafe("CC_AI_EASY"))
    ...
    call AddInfoQuestItem(Format(GetLocalizedStringSafe("IQ_BOSSES_0")).t(R2I(UnitGroupRespawnConfig_DEFAULT_TIMEOUT)).result())
