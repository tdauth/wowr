library WoWReforgedItemMagicalSeed initializer Init requires DestructableUtils

globals
    private boolexpr filterEnumRestoreDestructableLife = null
    private trigger endCastTrigger = CreateTrigger()
endglobals
...
private function TriggerConditionEndCast takes nothing returns boolean
...
private function Init takes nothing returns nothing
    ...
    call TriggerAddCondition(endCastTrigger, Condition(function TriggerConditionEndCast))
endfunction
