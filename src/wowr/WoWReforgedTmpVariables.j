...
function MoveTmpLocationToPolarProjectionOfUnit takes unit whichUnit, real face, real distance returns nothing
    call InitTmpLocations()
    call MoveLocation(udg_TmpLocation, PolarProjectionX(GetUnitX(whichUnit), face, distance), PolarProjectionY(GetUnitY(whichUnit), face, distance))
endfunction
