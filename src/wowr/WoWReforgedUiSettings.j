...
private function SetSettingsUIVisible takes player whichPlayer, boolean visible returns nothing
...
function ShowSettingsUIForPlayer takes player whichPlayer returns nothing
    call SetSettingsUIVisible(whichPlayer, true)
endfunction

private function HideSettingsUIForPlayer takes player whichPlayer returns nothing
    call SetSettingsUIVisible(whichPlayer, false)
endfunction
