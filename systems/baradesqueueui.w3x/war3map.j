...
function QueueUI__UpdateUIForPlayer takes player whichPlayer returns nothing
    ...
    local integer current= (Queue__playerQueue[GetPlayerId((whichPlayer))]) // INLINED!!
    local integer i= 0
    if ( (QueueUI__enabledForPlayer[GetPlayerId((whichPlayer))]) and not QueueUI__checked[playerId] ) then // INLINED!!
...
function QueueUI_CreateUI takes nothing returns nothing
    local integer i= 0
...
function QueueUI__TimerFunctionStart takes nothing returns nothing
...
function QueueUI__Init takes nothing returns nothing
    ...
    call TimerStart(CreateTimer(), 0.0, false, function QueueUI__TimerFunctionStart)

    call TriggerAddAction(FrameLoader__actionTrigger, (function QueueUI_CreateUI)) // INLINED!!
