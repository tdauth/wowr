...
//===================================================
    ...
    constant string QR_CODE_DISCORD                                  = "ReplaceableTextures\\CommandButtons\\BTNQR_Code_Discord.blp"
    constant string QR_CODE_WEBSITE                                  = "ReplaceableTextures\\CommandButtons\\BTNQR_Code_Website.blp"
    ...
    constant integer MOUNTS_SHOP                                     = 'n06U' // Neutral
    ...
    constant integer HIPPOGROPH_MOUNT                                = 'e02G'
    constant integer NETHER_DRAKE_MOUNT                              = 'n007'
    constant integer COUATL_MOUNT                                    = 'n0BH'
    ...
    constant integer PROTO_DRAKE_MOUNT                               = 'h0IR'
    constant integer CROW_MOUNT                                      = 'h07H'
    constant integer BEAR_MOUNT                                      = 'n0C4'
    constant integer POLAR_BEAR_MOUNT                                = 'n0C1'
    constant integer GIANT_SEA_TURTLE_MOUNT                          = 'h06C'
    constant integer HORSE_MOUNT                                     = 'h06E'
    constant integer UNDEAD_HORSE_MOUNT                              = 'h0MG'
    constant integer WHITE_TIGER_MOUNT                               = 'h0FC'
    constant integer ANCIENT_OF_WAR_MOUNT                            = 'h0Y4'
    constant integer LYNX_MOUNT                                      = 'h0PA'
    constant integer ELK_MOUNT                                       = 'h0Y1'
    constant integer KODO_BEAST_MOUNT                                = 'o01X'
    constant integer RAPTOR_MOUNT                                    = 'h0K4'
    constant integer DIREHORN_MOUNT                                  = 'h0Y7'
    constant integer MECHANOSTRIDER_MOUNT                            = 'h0KF'
    constant integer FLYING_MACHINE_MOUNT                            = 'h0KG'
    constant integer CLOUD_SERPENT_MOUNT                             = 'h0JL'
    constant integer BRUTOSAUR_MOUNT                                 = 'n0IW'
    constant integer TALBUK_MOUNT                                    = 'h0UF'
    constant integer PANTHER_MOUNT                                   = 'h0UG'
    constant integer WOLF_MOUNT                                      = 'h0YM'
    constant integer DWARF_CAR_MOUNT                                 = 'h0VI'
    constant integer ORC_CAR_MOUNT                                   = 'h0VJ'
    constant integer UNDEAD_CAR_MOUNT                                = 'h0VK'
    constant integer DEMON_CAR_MOUNT                                 = 'h0VL'
    constant integer GOBLIN_CAR_MOUNT                                = 'h0Y8'
    constant integer NIGHT_ELF_CAR_MOUNT                             = 'h0YB'
    constant integer SHIP_MOUNT                                      = 'h0XS'
    constant integer SUBMARINE_MOUNT                                 = 'h0XT'
    ...
    constant integer ITEM_GOBLIN_BURNING_GRENADES                    = 'I136' // advanced
    ...
    // Lore Master
    constant integer ITEM_ANKH_OF_REINCARNATION                      = 'ankh' // doctor
    constant integer ITEM_SCROLL_OF_RESURRECTION                     = 'srrc' // grand master
    constant integer ITEM_ARCANE_SCROLL                              = 'arsc' // master
    constant integer ITEM_SCROLL_OF_RESTORATION                      = 'sres' // adept
    constant integer ITEM_SCROLL_OF_THE_BEAST                        = 'sror' // advanced
    constant integer ITEM_SCROLL_OF_PROTECTION                       = 'spro' // novice

    // Sorcerer
    constant integer ITEM_WAND_OF_TELEKINESIS                        = 'I0XW' // doctor
    constant integer ITEM_WAND_OF_SHADOWSIGHT                        = 'wshs' // grand master
    ...
    constant integer ITEM_MASTER_ENCHANTING_FORMULA                  = 'I07J' // master
    constant integer ITEM_ADEPT_ENCHANTING_FORMULA                   = 'I07I' // adept
    constant integer ITEM_ADVANCED_ENCHANTING_FORMULA                = 'I07H' // advanced
    constant integer ITEM_NOVICE_ENCHANTING_FORMULA                  = 'I07F' // novice
    ...
    constant integer ITEM_NAVIGATION_WHEEL                           = 'I086' // master
    constant integer ITEM_COMPASS                                    = 'I085' // adept
    constant integer ITEM_TREASURE_MAP                               = 'I083' // advanced
    constant integer ITEM_CAPTAIN_SHIP                               = 'I082' // novice

    // Archaeologist
    constant integer EXCAVATION_SITE                                 = 'n0M2' // doctor
    constant integer ITEM_EXCAVATION_SITE                            = 'I160' // doctor
    constant integer ITEM_RANDOM_8                                   = 'I15Z' // grand master
    constant integer ITEM_RANDOM_7                                   = 'I0IH' // master
    constant integer ITEM_RANDOM_5                                   = 'I0IG' // adept
    constant integer ITEM_RANDOM_3                                   = 'I0IF' // advanced
    constant integer ITEM_RANDOM_1                                   = 'I0I6' // novice
    ...
    constant integer ITEM_RING_OF_THE_TRADING_GUILD                  = 'I0D6' // master
    constant integer ITEM_LARGE_BILL                                 = 'I0D5' // adept
    constant integer ITEM_BILL                                       = 'I0D4' // advanced
    ...
    constant integer ITEM_TINY_WATER_SUPPLY                          = 'I0JW' // advanced
    constant integer GRANARY                                         = 'h0M7'
    constant integer ITEM_TINY_GRANARY                               = 'I0KA' // adept
    constant integer WIND_MILL                                       = 'h0M8'
    constant integer ITEM_TINY_WIND_MILL                             = 'I0KB' // master
    ...
    // Inscriptor
    constant integer ITEM_DOCTOR_GLYPH                               = 'I15X' // doctor
    constant integer ITEM_GRAND_MASTER_GLYPH                         = 'I15W' // grand master
    constant integer ITEM_MASTER_GLYPH                               = 'I0NR' // master
    constant integer ITEM_ADVANCED_GLYPH                             = 'I0NQ' // adept
    constant integer ITEM_ADEPT_GLYPH                                = 'I0NP' // advanced
    constant integer ITEM_NOVICE_GLYPH                               = 'I0NO' // novice

    // Necromancer
    constant integer ITEM_ROD_OF_NECROMANCY                          = 'rnec' // novice
    constant integer ITEM_WAND_OF_CORPSES                            = 'I0S9' // advanced
    constant integer ITEM_SACRIFICAL_SCULL                           = 'skul' // adept
    constant integer ITEM_BOOK_OF_THE_DEAD                           = 'fgsk' // master
    constant integer ITEM_SCROLL_OF_ANIMATE_DEAD                     = 'sand' // grand master
    constant integer ITEM_TINY_NECROMANCER_GRAVEYARD                 = 'I110' // doctor
    constant integer NECROMANCER_GRAVEYARD                           = 'u038'
    constant integer NECROMANCER_MEAT_WAGON                          = 'u03M'

    // Golem Sculptor
    constant integer ITEM_TINY_MUD_GOLEM                             = 'I0SJ' // novice
    constant integer ITEM_TINY_WAR_GOLEM                             = 'I0SL' // advanced
    constant integer ITEM_TINY_SIEGE_GOLEM                           = 'I0SK' // adept
    constant integer ITEM_TINY_FLESH_GOLEM                           = 'I0SM' // master
    ...
    // Combiner
    // TODO Add item types.
    constant integer ITEM_MASTER_COMBINATION_TOOL                    = 'I0T9' // master
    constant integer ITEM_ADVANCED_COMBINATION_TOOL                  = 'I0T8' // adept
    constant integer ITEM_COMBINATION_TOOL                           = 'I0T7' // advanced
    constant integer ITEM_SMALL_COMBINATION_TOOL                     = 'I0T5' // novice
    ...
    constant integer ITEM_BEAR_TRAP                                  = 'I0VV' // master
    ...
    // Miner
    constant integer ITEM_MINES                                      = 'I0W8' // master
    ...
    constant integer ITEM_RECIPE                                     = 'I0XC' // master
    constant integer ITEM_RANDOM_INGREDIENT                          = 'I0XB' // adept
    constant integer ITEM_KITCHEN_KNIFE                              = 'I0XA' // advanced
    ...
    constant integer ITEM_FISH_TRAP                                  = 'I0Q2' // advanced
    constant integer ITEM_FISHING_ROD                                = 'I0X9' // adept
    constant integer ITEM_FISH_MARKET                                = 'I0X8' // master
    constant integer FISH_MARKET_FISHERMAN                           = 'n0J8'
    // TODO Add item types.

    // Prospector
    constant integer ITEM_GOLD_DRILL                                 = 'I11X' // novice
    constant integer ITEM_MAGICAL_GOLD_COIN                          = 'I120' // advanced
    constant integer GOLD_PANNING                                    = 'h0XX'
    constant integer ITEM_GOLD_PANNING                               = 'I11Y' // master

    // Lumberjack
    constant integer ITEM_FELLING_AXE                                = 'I0XO' // novice
    constant integer ITEM_MAGICAL_SEED                               = 'I00V' // adept
    constant integer ITEM_BUNDLE_OF_LUMBER                           = 'lmbr' // adept
    constant integer ITEM_MAGICAL_CUTTER                             = 'I02V' // adept
    constant integer SAWMILL                                         = 'h0UH'
    constant integer ITEM_SAWMILL                                    = 'I0XN' // master

    // Warlock
    constant integer ITEM_WAND_OF_DRAIN                              = 'I0YH' // novice
    constant integer ITEM_INFERNO_STONE                              = 'infs' // advanced
    constant integer ITEM_DEMON_BLOOD                                = 'I0Y7' // adept
    constant integer ITEM_TINY_DEMON_GATE                            = 'I0YG' // master
    ...
    // Thief
    constant integer ITEM_LOCK_PICK                                  = 'I0DF' // novice
    constant integer ITEM_ITEM_LOCKER                                = 'I09H' // advanced
    constant integer SAFE                                            = 'h0OH'
    constant integer ITEM_TINY_SAFE                                  = 'I0FN' // adept
    constant integer ITEM_LOCKED_ITEM_SUMMONER                       = 'I09M' // master
    constant integer ITEM_PICKPOCKETING                              = 'I03F' // grand master
    constant integer THIEVES_GUILD_THIEF                             = 'n076'
    constant integer ITEM_TINY_THIEVES_GUILD_THIEF                   = 'I10R' // doctor

    // Astromancer
    constant integer ITEM_NAVIGATION_SCROLL                          = 'I12V' // novice
    constant integer ITEM_TINY_PORTAL_ASTROMANCER                    = 'I12W' // novice
    constant integer ITEM_FLARE_GUN                                  = 'fgun' // advanced
    constant integer ITEM_ESCAPE_PORTAL                              = 'I0CO' // advanced
    constant integer ITEM_METEOR_STONE                               = 'I12U' // adept
    constant integer ITEM_SCROLL_OF_TOWN_PORTAL                      = 'stwp' // adept
    constant integer ARCANE_OBSERVATORY_ASTROMANCER                  = 'n0MO'
    constant integer ITEM_ARCANE_OBSERVATORY_ASTROMANCER             = 'I12Z' // master
    constant integer MOON                                            = 'n0OL' // grand master
    constant integer ITEM_MOON                                       = 'I19F' // grand master
    constant integer ITEM_MOONSTONE                                  = 'moon' // grand master
    constant integer STAR                                            = 'n0OK' // doctor
    constant integer ITEM_STAR                                       = 'I19E' // doctor
    constant integer ITEM_SUNSTONE                                   = 'I0OW' // doctor

    // Bard
    constant integer RECORD_PLAYER                                   = 'h0G0'
    constant integer ITEM_RECORD_PLAYER                              = 'I14Q' // master
    constant integer MUSIC_STORM_EARTH_FIRE                          = 'h0G3'
    constant integer STOP_MUSIC                                      = 'h0G4'
    constant integer ITEM_POEM                                       = 'I14S' // advanced
    constant integer ITEM_FLUTE                                      = 'I14R' // adept
    constant integer ITEM_SONG                                       = 'I14I' // novice
    ...
    constant integer ITEM_RANDOM_ARTIFACT                            = 'I0D7'
    ...
    constant integer TOME_OF_EXPERIENCE                              = 'texp' // master
    constant integer TOME_OF_GREATER_EXPERIENCE                      = 'tgxp' // grand master
    constant integer TOME_OF_INTELLIGENCE                            = 'tint'
    constant integer TOME_OF_INTELLIGENCE_2                          = 'tin2'
    constant integer TOME_OF_KNOWLEDGE                               = 'tpow' // novice
    constant integer TOME_OF_STRENGTH                                = 'tstr'
    constant integer TOME_OF_STRENGTH_2                              = 'tst2'
    constant integer TOME_OF_POWER                                   = 'tkno' // doctor
    constant integer TOME_OF_ARMOR                                   = 'I13G' // adept
    constant integer TOME_OF_DAMAGE                                  = 'I13E' // adept
    constant integer TOME_OF_MOVEMENT                                = 'I1A8' // adept
    constant integer TOME_OF_SIGHT                                   = 'I1A7' // adept
    constant integer TOME_OF_MAGIC                                   = 'I1A4' // master
    constant integer TOME_OF_CHAOS                                   = 'I1A5'
    constant integer TOME_OF_DIVINITY                                = 'I1A6'
    constant integer TOME_OF_SKILL_POINTS                            = 'I156'
    constant integer MANUAL_OF_HEALTH                                = 'manh' // advanced
    constant integer MANUAL_OF_MANA                                  = 'I13F' // advanced
    constant integer TOME_OF_LIFE_REGENARTION                        = 'I1AB' // advanced
    constant integer TOME_OF_MANA_REGENERATION                       = 'I1AC' // advanced
    ...
    constant integer GRANITE_GOLEM                                   = 'nggr'
    ...
    constant integer WATER_ELEMENTAL_2                               = 'hwt2'
    constant integer WATER_ELEMENTAL_3                               = 'hwt3'
    constant integer WATER_ELEMENTAL_4                               = 'h001'
    ...
    constant integer SPIRIT_WOLF_1                                   = 'osw1'
    constant integer SPIRIT_WOLF_2                                   = 'osw2'
    constant integer SPIRIT_WOLF_3                                   = 'osw3'
    constant integer SPIRIT_WOLF_4                                   = 'o000'
    constant integer SERPENT_WARD_1                                  = 'osp1'
    constant integer SERPENT_WARD_2                                  = 'osp2'
    constant integer SERPENT_WARD_3                                  = 'osp3'
    constant integer SERPENT_WARD_4                                  = 'osp4'
    ...
    constant integer OWL_SCOUT_1                                     = 'nowl'
    constant integer OWL_SCOUT_2                                     = 'now2'
    constant integer OWL_SCOUT_3                                     = 'now3'
    constant integer OWL_SCOUT_4                                     = 'n002'
    constant integer TREANT                                          = 'efon'
    constant integer TREANT_4                                        = 'e001'
    constant integer AVATAR_OF_VENGEANCE                             = 'espv'
    constant integer ETERNAL_AVATAR_OF_VENGEANCE                     = 'e006'
    constant integer DARK_MINION_1                                   = 'ndr1'
    constant integer DARK_MINION_2                                   = 'ndr2'
    constant integer DARK_MINION_3                                   = 'ndr3'
    constant integer DOOM_GUARD_SUMMONED                             = 'nba2'
    constant integer FIRE_1                                          = 'npn1'
    constant integer STORM_1                                         = 'npn2'
    constant integer EARTH_1                                         = 'npn3'
    constant integer FIRE_2                                          = 'n009'
    constant integer STORM_2                                         = 'n00A'
    constant integer EARTH_2                                         = 'n008'
    constant integer SPIRIT_BEAR_1                                   = 'ngz1'
    constant integer SPIRIT_BEAR_2                                   = 'ngz2'
    constant integer SPIRIT_BEAR_3                                   = 'ngz3'
    constant integer SPIRIT_HAWK_1                                   = 'nwe1'
    constant integer SPIRIT_HAWK_2                                   = 'nwe2'
    constant integer SPIRIT_HAWK_3                                   = 'nwe3'
    constant integer QUILBEAST_1                                     = 'nqb1'
    constant integer QUILBEAST_2                                     = 'nqb2'
    constant integer QUILBEAST_3                                     = 'nqb3'
    constant integer LAVA_SPAWN_1                                    = 'nlv1'
    constant integer LAVA_SPAWN_2                                    = 'nlv2'
    ...
    constant integer ITEM_UNDEAD_ZIGURRAT                            = 'I0M3'
    constant integer ITEM_UNDEAD_SPIRIT_TOWER                        = 'I0MD'
    constant integer ITEM_UNDEAD_NERUBIAN_TOWER                      = 'I0MA'
    constant integer ITEM_UNDEAD_ALTAR                               = 'I0M4'
    constant integer ITEM_UNDEAD_CRYPT                               = 'I0M7'
    constant integer ITEM_UNDEAD_GRAVEYARD                           = 'I0M8'
    constant integer ITEM_UNDEAD_TEMPLE_OF_THE_DAMNED                = 'I0ME'
    constant integer ITEM_UNDEAD_BONEYARD                            = 'I0M6'
    constant integer ITEM_UNDEAD_SLAUGHTERHOUSE                      = 'I0MC'
    constant integer ITEM_UNDEAD_TOMB_OF_RELICS                      = 'I0MF'
    constant integer ITEM_UNDEAD_SACRIFICIAL_PIT                     = 'I0MB'
    constant integer ITEM_UNDEAD_SHIPYARD                            = 'I0MU'
    constant integer ITEM_UNDEAD_SPECIAL_BUILDING                    = 'I0MW'
    constant integer ITEM_UNDEAD_HOUSING                             = 'I0MV'
    ...
    constant integer DWARF_WORKSHOP                                  = 'h032' // workshop
    constant integer DWARF_BEASTIARY                                 = 'h02Z' // aviary
    constant integer DWARF_HOUSE                                     = 'h036' // farm
    constant integer DWARF_TOWER                                     = 'h039' // tower
    constant integer DWARF_TOWER_GUN                                 = 'h03B' // arcane tower
    constant integer DWARF_TOWER_GUARD                               = 'h03C' // guard tower
    constant integer DWARF_TOWER_CANNON                              = 'h03D' // cannon tower
    ...
    constant integer DWARF_TROLL_SLAYER                              = 'h02U' // footman
    constant integer DWARF_RIFLEMAN                                  = 'h02W' // rifleman
    constant integer DWARF_RIDER                                     = 'h02Y' // knight
    constant integer DWARF_BATTLEPRIEST                              = 'h03A' // priest
    constant integer DWARF_RUNECASTER                                = 'o01L' // sorceress
    constant integer DWARF_WAR_GOLEM                                 = 'n04X' // spell breaker
    constant integer DWARF_WAR_GOLEM_M                               = 'n052' // spell breaker
    constant integer DWARF_MORTAR                                    = 'h03H'
    constant integer DWARF_POLAR_BEAR                                = 'n04T' // tauren
    constant integer DWARF_GRYPHON_RIDER                             = 'h035'
    constant integer DWARF_GRYPHON                                   = 'n04U' // dragonhawk
    constant integer DWARF_GRYPHON_M                                 = 'n04V' // dragonhawk
    constant integer DWARF_FLYING_MACHINE                            = 'h03I'
    constant integer DWARF_SIEGE_ENGINE                              = 'h03G'
    constant integer DWARF_SIEGE_ENGINE_BARRAGE                      = 'h03J'
    constant integer DWARF_ELITE_SIEGE_TANK                          = 'h03K'
    constant integer DWARF_STEAM_FORTRESS                            = 'h03F' // workshop 4
    constant integer DWARF_SUBMARINE                                 = 'h0WL' // special ship 1
    ...
    constant integer UPG_DWARF_BATTLEPRIEST                          = 'R03U'
    constant integer UPG_DWARF_RUNECASTER                            = 'R03T'
    ...
    constant integer UPG_DWARF_POLAR_BEARS                           = 'R034'
    ...
    constant integer TAUREN_BARRACKS                                  = 'o03A'
    ...
    constant integer TAUREN_SHIPYARD                                  = 'o007'
    ...
    constant integer TAUREN_KODO_BEAST_RIDERLESS                      = 'o06G' // siege engine
    constant integer TAUREN_KODO_BEAST_RIDER                          = 'o06Q' // knight
    constant integer TAUREN_SPIRIT_WALKER                             = 'o06J' // sorceress and spellbreaker
    constant integer TAUREN_SPIRIT_WALKER_M                           = 'o06O' // sorceress and spellbreaker morphed
    constant integer TAUREN_SPIRIT_WYVERN                             = 'o03E' // dragon hawk and flying machine
    constant integer TAUREN_TAUREN                                    = 'o06L' // tauren
    constant integer TAUREN_ELITE_TAUREN                              = 'o06M' // upgrade from Tauren
    constant integer TAUREN_AXE_FIGHTER                               = 'o06E' // footman
    constant integer TAUREN_CATAPULT                                  = 'o06F' // mortar
    constant integer TAUREN_DRUID                                     = 'o06H' // priest
    constant integer TAUREN_DRUID_M                                   = 'o06I' // priest morphed
    constant integer TAUREN_SPEAR_THROWER                             = 'o06N' // rifleman
    constant integer TAUREN_WORKER                                    = 'o02N' // worker
    constant integer TAUREN_WYVERN                                    = 'o03D' // gryphon
    ...
    constant integer ABILITY_CARRION_SWARM                           = 'ACca'
    ...
    constant integer ABILITY_BRILLIANCE_AURA                         = 'ACba'
    ...
    constant integer ABILITY_EAT_TREE                                = 'Aeat'
    constant integer ABILITY_MASS_FORESTATION                        = 'A17G'
    ...
    constant integer ABILITY_SUMMON_BEAR                             = 'A17F'
    ...
    constant integer ABILITY_CRITICAL_STRIKE                         = 'ACct'
    ...
    constant integer ABILITY_MASS_INVISIBILITY                       = 'A0QD'
    constant integer ABILITY_MASS_INVISIBILITY_DUMMY                 = 'A0QE'
    constant integer ABILITY_MASS_POLYMORPH                          = 'A0QS'
    constant integer ABILITY_MASS_POLYMORPH_DUMMY                    = 'A0QT'
    constant integer ABILITY_MASS_SLOW                               = 'A0QF'
    constant integer ABILITY_MASS_SLOW_DUMMY                         = 'A0QG'
    constant integer ABILITY_MASS_ENSNARE                            = 'A1W4'
    constant integer ABILITY_MASS_ENSNARE_DUMMY                      = 'A1HW'
    constant integer ABILITY_MASS_ILLUSION                           = 'A1II'
    constant integer ABILITY_MASS_ILLUSION_DUMMY                     = 'A1IJ'
    constant integer ABILITY_MASS_CYCLONE                            = 'A1H8'
    constant integer ABILITY_MASS_CYCLONE_DUMMY                      = 'A1HA'
    constant integer ABILITY_MASS_REJUVENATION                       = 'A1H5'
    constant integer ABILITY_MASS_REJUVENATION_DUMMY                 = 'A1H6'
    constant integer ABILITY_MASS_FIREBOLT                           = 'A1GB'
    constant integer ABILITY_MASS_FIREBOLT_DUMMY                     = 'A1GA'
    constant integer ABILITY_MASS_BLOODLUST                          = 'A173'
    constant integer ABILITY_MASS_BLOODLUST_DUMMY                    = 'A174'
    constant integer ABILITY_MASS_MANA_BURN                          = 'A15V'
    constant integer ABILITY_MASS_MANA_BURN_DUMMY                    = 'A15W'
    constant integer ABILITY_MASS_CRIPPLE                            = 'A135'
    constant integer ABILITY_MASS_CRIPPLE_DUMMY                      = 'A136'
    constant integer ABILITY_MASS_HEX                                = 'A14L'
    constant integer ABILITY_MASS_HEX_DUMMY                          = 'A14M'
    constant integer ABILITY_MASS_SLEEP                              = 'A14I'
    constant integer ABILITY_MASS_SLEEP_DUMMY                        = 'A14K'
    constant integer ABILITY_MASS_CONTROL_MAGIC                      = 'A14T'
    constant integer ABILITY_MASS_CONTROL_MAGIC_DUMMY                = 'A14S'
    constant integer ABILITY_MASS_ENTANGLING_ROOTS                   = 'A14F'
    constant integer ABILITY_MASS_ENTANGLING_ROOTS_DUMMY             = 'A14G'
    constant integer ABILITY_MASS_ENTANGLING_ROOTS_ITEM              = 'A1MI'
    ...
    constant integer RAMKAHEN_HUNTRESS                               = 'E015'
    ...
    constant integer GOBLIN_SUBMARINE_PILOT_HERO                     = 'N0BC'
    ...
    constant integer XALATATH                                        = 'E01A'
    constant integer ARCH_LICH                                       = 'U003'
    constant integer AVATAR_OF_SARGERAS                              = 'U00V'
    constant integer XAVIUS                                          = 'N0M8'
    constant integer YSERA                                           = 'N0M7'
    constant integer OHNAHRA                                         = 'N0IM'
    constant integer YULON                                           = 'N0IL'
    constant integer SMOLDERON                                       = 'N0DR'
    constant integer NEPTULON                                        = 'N0IG'
    ...
    constant integer YOGG_SARON                                      = 'N069'
    constant integer NZOTH                                           = 'N06C'
    constant integer CTHUN                                           = 'N06E'
    constant integer DENATHRIUS                                      = 'U03L'
    constant integer SIR_GREGORY_EDMUNSON                            = 'H01P'
    ...
    constant integer KIL_JAEDEN_BOSS                                 = 'N01O'
    constant integer VERAKU                                          = 'N02T'
    constant integer VARIMATHRAS                                     = 'U000'
...
// Apparently, it has some delay in it which is why it does not work in trigger conditions.
// Calling it too often will lead to massive delays in multiplayer games and units not reacting at all to player orders.
...
// Barade: Removed with Reforged patch 2.0.2
