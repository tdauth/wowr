...
//===================================================
    ...
    // Hero Journey
    constant integer HERO_JOURNEY_HERO_STANDARD_ABILITIES            = 6
    constant integer HERO_JOURNEY_RANDOM_EVENTS                      = 7
    constant integer HERO_JOURNEY_EQUIPMENT_BAG_1                    = 8
    constant integer HERO_JOURNEY_MOUNTS                             = 9
    constant integer HERO_JOURNEY_PROFESSION_2                       = 10
    constant integer HERO_JOURNEY_BONUS_RACES                        = 11
    constant integer HERO_JOURNEY_HAND_OF_GOD                        = 12
    constant integer HERO_JOURNEY_HIDDEN_BASES                       = 12
    constant integer HERO_JOURNEY_BONUS_HEROS                        = 13
    constant integer HERO_JOURNEY_EQUIPMENT_BAG_2                    = 13
    constant integer HERO_JOURNEY_HERO_2                             = 14
    constant integer HERO_JOURNEY_PROFESSION_3                       = 14
    constant integer HERO_JOURNEY_BOSS_HEROES                        = 15
    constant integer HERO_JOURNEY_BONUS_MOUNTS                       = 16
    constant integer HERO_JOURNEY_BOSS_FIGHT_ISLAND                  = 16
    constant integer HERO_JOURNEY_RACE_2                             = 17
    constant integer HERO_JOURNEY_EQUIPMENT_BAG_3                    = 17
    constant integer HERO_JOURNEY_HERO_3                             = 18
    constant integer HERO_JOURNEY_RACE_3                             = 18
    constant integer HERO_JOURNEY_AI                                 = 19
    constant integer HERO_JOURNEY_VOID_LORDS                         = 20
    constant integer HERO_JOURNEY_ADVANCED_CHAT_COMMANDS             = 20
    constant integer HERO_JOURNEY_MAX_BOSS_LEVELS                    = 20
    constant integer HERO_JOURNEY_ALL_RACES                          = 20
    constant integer HERO_JOURNEY_ALL_PROFESSIONS                    = 20
