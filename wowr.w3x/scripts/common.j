...
//===================================================
    ...
    constant string MAP_VERSION                                      = "3.21"
    ...
    constant integer ANCIENTGREECE_ALTAR                             = 'h0m5'
    constant integer ANCIENTGREECE_ARCHERY_RANGE                     = 'h0LW' // workshop
    constant integer ANCIENTGREECE_BARRACKS                          = 'h0LJ'
    constant integer ANCIENTGREECE_BLACKSMITH                        = 'h0LT'
    constant integer ANCIENTGREECE_HOUSE                             = 'h0LL'
    constant integer ANCIENTGREECE_HOUSE_URBAN_PLANNING              = 'h0M6'
    constant integer ANCIENTGREECE_SHOP                              = 'h0LR'
    constant integer ANCIENTGREECE_STABLES                           = 'h0LU' // gryphon aviary
    constant integer ANCIENTGREECE_STOCKPILE                         = 'h0FP' // lumber mill
    constant integer ANCIENTGREECE_TEMPLE                            = 'h0LQ' // arcane sanctuary
    constant integer ANCIENTGREECE_WATCH_TOWER                       = 'h0LN'
    constant integer ANCIENTGREECE_LIGHTHOUSE                        = 'h0LM' // special building
    constant integer ANCIENTGREECE_DOCK                              = 'h0LZ' // shipyard


    constant integer UPG_ANCIENTGREECE_ASTROLOGY                     = 'R09V'
    constant integer UPG_ANCIENTGREECE_BACKPACK                      = 'R09S'
    constant integer UPG_ANCIENTGREECE_ARMOR                         = 'R0A8'
    constant integer UPG_ANCIENTGREECE_MELEE                         = 'R0A7'
    constant integer UPG_ANCIENTGREECE_RANGED                        = 'R0A9'
    constant integer UPG_ANCIENTGREECE_IMPROVED_WATER_MILL           = 'R0A1'
    constant integer UPG_ANCIENTGREECE_CITY_STATES                   = 'R0A2'
    constant integer UPG_ANCIENTGREECE_DEMOCRACY                     = 'R0A3'
    constant integer UPG_ANCIENTGREECE_REINCARNATION                 = 'R0A4'
    constant integer UPG_ANCIENTGREECE_DEFEND                        = 'R09Y'
    constant integer UPG_ANCIENTGREECE_RIDE_DOWN                     = 'R09Z'
    constant integer UPG_ANCIENTGREECE_SHEEP_FARMING                 = 'R09X'
    constant integer UPG_ANCIENTGREECE_MYTHOLOGY                     = 'R09T'
    constant integer UPG_ANCIENTGREECE_PHYSICIAN                     = 'R09W'
    constant integer UPG_ANCIENTGREECE_PRIEST                        = 'R09U'
    constant integer UPG_ANCIENTGREECE_URBAN_PLANNING                = 'R0A0'
    constant integer UPG_ANCIENTGREECE_LIGHTHOUSE                    = 'R093' // special building

    constant integer ANCIENTGREECE_WORKER                            = 'h0LK' // worker
    constant integer ANCIENTGREECE_SWORDSMAN                         = 'h0LP'
    constant integer ANCIENTGREECE_ARCHER                            = 'n0D8'
    constant integer ANCIENTGREECE_SLINGER                           = 'h0M1'
    constant integer ANCIENTGREECE_CATAPULT                          = 'o057'
    constant integer ANCIENTGREECE_BATTERING_RAM                     = 'o058'
    constant integer ANCIENTGREECE_CENTAUR_ARCHER                    = 'n0D9'
    constant integer ANCIENTGREECE_HARPY                             = 'n0DD'
    constant integer ANCIENTGREECE_CHARIOT                           = 'h0LV'
    constant integer ANCIENTGREECE_COMPANION_CAVALRY                 = 'h0LO'
    constant integer ANCIENTGREECE_HOPLITE                           = 'h0LI'
    constant integer ANCIENTGREECE_HORSE_CART                        = 'h0M2'
    constant integer ANCIENTGREECE_PHYSICIAN                         = 'h0M4'
    constant integer ANCIENTGREECE_PRIEST                            = 'h0LS'
    constant integer ANCIENTGREECE_HELEPOLIS                         = 'e01H'
    constant integer ANCIENTGREECE_SPARTAN                           = 'h0M9'

    constant integer ANCIENTGREECE_CITIZEN_MALE                      = 'n0DA'
    constant integer ANCIENTGREECE_CITIZEN_FEMALE                    = 'n0DB'
    constant integer ANCIENTGREECE_HOUSING                           = 'h0M3'
    ...
    // Medieval
    constant integer MEDIEVAL_TIER_1                                 = 'h0AN'
    constant integer MEDIEVAL_TIER_2                                 = 'h0AV'
    constant integer MEDIEVAL_TIER_3                                 = 'h0AW'
    constant integer MEDIEVAL_TIER_4                                 = 'h0C0'
    constant integer MEDIEVAL_TIER_5                                 = 'h0C1'
    constant integer MEDIEVAL_TIER_6                                 = 'h0C2'
    constant integer MEDIEVAL_TIER_7                                 = 'h0C3'
    constant integer MEDIEVAL_FARM                                   = 'h0CA'
    constant integer MEDIEVAL_HOUSE                                  = 'h0AS'
    constant integer MEDIEVAL_STONEMASON                             = 'h0CC'
    constant integer MEDIEVAL_PLANTATION                             = 'h0C7'
    constant integer MEDIEVAL_STORAGE_SHED                           = 'h0CB'
    constant integer MEDIEVAL_WATER_MILL                             = 'h0C9'
    constant integer MEDIEVAL_TAVERN                                 = 'h0AT' // altar
    constant integer MEDIEVAL_ARCHERY                                = 'h0AP'
    constant integer MEDIEVAL_BARRACKS                               = 'h0CF'
    constant integer MEDIEVAL_ENCAMPMENT                             = 'h0BJ'
    constant integer MEDIEVAL_LUMBER_MILL                            = 'h0AU'
    constant integer MEDIEVAL_BLACKSMITH                             = 'h0CD'
    constant integer MEDIEVAL_STABLES                                = 'h0AZ'
    constant integer MEDIEVAL_UNIVERSITY                             = 'h0B8'
    constant integer MEDIEVAL_CHURCH                                 = 'h0B7'
    constant integer MEDIEVAL_KNIGHTS_CASTLE                         = 'h0AX'
    constant integer MEDIEVAL_SIEGE_WORKSHOP                         = 'h0AR'
    constant integer MEDIEVAL_SCOUT_TOWER                            = 'h0BA'
    constant integer MEDIEVAL_GUARD_TOWER                            = 'h0BI'
    constant integer MEDIEVAL_SENTRY_TOWER                           = 'h0CE'
    constant integer MEDIEVAL_WELL                                   = 'e015'
    constant integer MEDIEVAL_MARKET                                 = 'h0B5' // shop
    constant integer MEDIEVAL_CATHEDRAL                              = 'h0BC' // special building
    constant integer MEDIEVAL_DOCK                                   = 'h0BK' // shipyard
    //constant integer MEDIEVAL_TREBUCHET                              = 'h0C8'

    constant integer UPG_MEDIEVAL_BACKPACK                           = 'R075'
    constant integer UPG_MEDIEVAL_CAVALERY_PLATING                   = 'R07B'
    constant integer UPG_MEDIEVAL_CROSSBOWS                          = 'R074'
    constant integer UPG_MEDIEVAL_QUARTER                            = 'R073'
    constant integer UPG_MEDIEVAL_FLETCHING                          = 'R077'
    constant integer UPG_MEDIEVAL_TOWN_WATCH                         = 'R078'
    constant integer UPG_MEDIEVAL_WHEELBARROW                        = 'R079'
    constant integer UPG_MEDIEVAL_HERESY                             = 'R07A'
    constant integer UPG_MEDIEVAL_CATHEDRAL                          = 'R06K'

    constant integer MEDIEVAL_VILLAGER                               = 'h0AQ' // worker
    constant integer MEDIEVAL_ORGAN_CANNON                           = 'e012'
    constant integer MEDIEVAL_BATTLE_ELEPHANT                        = 'e013'
    constant integer MEDIEVAL_SIEGE_TOWER                            = 'e000'
    constant integer MEDIEVAL_SIEGE_LADDER                           = 'h0AY'
    constant integer MEDIEVAL_CRUSADER                               = 'h0BH'
    constant integer MEDIEVAL_KNIGHT                                 = 'h0CP'
    constant integer MEDIEVAL_SCOUT                                  = 'h0C5'
    constant integer MEDIEVAL_HUSSAR                                 = 'h0CQ'
    constant integer MEDIEVAL_MOUNTED_KNIGHT                         = 'h0C6'
    constant integer MEDIEVAL_SPANISH_CONQUISTADOR                   = 'h0TR'
    constant integer MEDIEVAL_WAGON                                  = 'h0BM'
    constant integer MEDIEVAL_BOMBARD                                = 'h0BB'
    constant integer MEDIEVAL_MONK                                   = 'h0BE'
    constant integer MEDIEVAL_WIZARD                                 = 'h0BG'
    constant integer MEDIEVAL_WITCH                                  = 'h0C4'
    constant integer MEDIEVAL_ARCHER                                 = 'h09I'
    constant integer MEDIEVAL_CROSSBOWMAN                            = 'h09R'
    constant integer MEDIEVAL_SAMURAI                                = 'h09U'
    constant integer MEDIEVAL_SWISS_GUARD                            = 'h09T'
    constant integer MEDIEVAL_MANTLET                                = 'o035'
    constant integer MEDIEVAL_BATTERING_RAM                          = 'o034'
    constant integer MEDIEVAL_CATAPULT                               = 'o033'
    constant integer MEDIEVAL_TREBUCHET                              = 'o031'
    constant integer MEDIEVAL_PETARD                                 = 'n09K'
    constant integer MEDIEVAL_CHINESE_SOLDIER                        = 'h0AA'

    constant integer MEDIEVAL_CITIZEN_MALE                           = 'n09J'
    constant integer MEDIEVAL_CITIZEN_FEMALE                         = 'n0BO'
    constant integer MEDIEVAL_PET                                    = 'n00Q'
    constant integer MEDIEVAL_HOUSING                                = 'h0BZ'

    // Union
    constant integer UNION_TIER_1                                    = 'h0SE'
    constant integer UNION_TIER_2                                    = 'h0T5'
    constant integer UNION_TIER_3                                    = 'h0T6'
    constant integer UNION_TENT                                      = 'h0SF' // farm
    constant integer UNION_SALOON                                    = 'h0SG' // altar
    constant integer UNION_BARRACKS                                  = 'h0SH'
    constant integer UNION_LUMBER_MILL                               = 'h0SU'
    constant integer UNION_BLACKSMITH                                = 'h0SK'
    constant integer UNION_WORKSHOP                                  = 'h0SJ'
    constant integer UNION_TIPI                                      = 'h0SL'
    constant integer UNION_GUARD_TOWER                               = 'h0SP'
    constant integer UNION_MARKET                                    = 'h0ST' // shop

    constant integer UPG_UNION_BACKPACK                              = 'R0FO'
    constant integer UPG_UNION_BAYONET                               = 'R0FP'
    constant integer UPG_UNION_TRAINED_HORSES                        = 'R0FN'

    constant integer UNION_SABOTEUR                                  = 'h0SD' // worker
    constant integer UNION_CAVALRY                                   = 'h0SO'
    constant integer UNION_COVERED_WAGON                             = 'h0SQ'
    constant integer UNION_MOUNTED_APACHE                            = 'h0SX'
    constant integer UNION_OFFICER                                   = 'h0SS'
    constant integer UNION_RIFLEMAN                                  = 'h0SI'
    constant integer UNION_CANNON                                    = 'h0SN'
    ...
    constant integer GERMANS_WWII_PET                                = 'n0C7'
    constant integer GERMANS_WWII_CHILD                              = 'n0CV'
    constant integer GERMANS_WWII_HOUSING                            = 'h0MZ'

    // Free People of Middle Earth
    constant integer FREEPEOPLE_TIER_1                               = 'h0CT' // tier 1
    constant integer FREEPEOPLE_TIER_2                               = 'h0UQ' // tier 2
    constant integer FREEPEOPLE_TIER_3                               = 'h0UR' // tier 3
    ...
    constant integer FREEPEOPLE_MINAS_TIRITH                         = 'h0WR' // special building

    constant integer UPG_FREEPEOPLE_BACKPACK                         = 'R0GK'
    constant integer UPG_FREEPEOPLE_MINAS_TIRITH                     = 'R0HU'
    constant integer UPG_FREEPEOPLE_ARMOR                            = 'R07G'
    constant integer UPG_FREEPEOPLE_RANGE                            = 'R07H'
    constant integer UPG_FREEPEOPLE_MELEE                            = 'R07I'
    constant integer UPG_FREEPEOPLE_RIDE_DOWN                        = 'R07J'
    ...
    constant integer UPG_GALACTIC_REPUBLIC_BACKPACK                  = 'R0HJ'
    ...
    // Rebel Alliance
    constant integer REBEL_ALLIANCE_TIER_1                           = 'h0VS'
    constant integer REBEL_ALLIANCE_BARRACKS                         = 'h0VR'
    constant integer REBEL_ALLIANCE_JEDI_ACADEMY                     = 'h0W0' // arcane sanctum
    constant integer REBEL_ALLIANCE_SPACEPORT                        = 'h0VU'
    constant integer REBEL_ALLIANCE_FARM                             = 'o059'
    constant integer REBEL_ALLIANCE_ALTAR                            = 'h0W1'
    constant integer REBEL_ALLIANCE_SHOP                             = 'h0W5'
    constant integer REBEL_ALLIANCE_CANTINA                          = 'h0W8' // workshop
    constant integer REBEL_ALLIANCE_ECHO_SHIELD                      = 'h0W6' // special building

    constant integer UPG_REBEL_ALLIANCE_BACKPACK                     = 'R0HE'
    constant integer UPG_REBEL_ALLIANCE_BLASTERS                     = 'R0HH'
    constant integer UPG_REBEL_ALLIANCE_IRON_PLATING                 = 'R0HI'
    constant integer UPG_REBEL_ALLIANCE_JEDI                         = 'R0HF'
    constant integer UPG_REBEL_ALLIANCE_ECHO_SHIELD                  = 'R0HG'

    constant integer REBEL_ALLIANCE_WORKER                           = 'h0VQ'
    constant integer REBEL_ALLIANCE_RECRUIT                          = 'h0VP'
    constant integer REBEL_ALLIANCE_TROOPER                          = 'h0VY'
    constant integer REBEL_ALLIANCE_REPEATER                         = 'h0VZ'
    constant integer REBEL_ALLIANCE_JEDI                             = 'h0W4'
    constant integer REBEL_ALLIANCE_XWING                            = 'h0VT'
    constant integer REBEL_ALLIANCE_YWING                            = 'h0VX'
    constant integer REBEL_ALLIANCE_BWING                            = 'h0VV'
    constant integer REBEL_ALLIANCE_TUSKEN_RAIDER                    = 'h03N'

    constant integer REBEL_ALLIANCE_CITIZEN_MALE                     = 'n033'
    constant integer REBEL_ALLIANCE_CITIZEN_FEMALE                   = 'n0BP'
    ...
    constant integer CRUSHING_WAVE                                   = 'A05L'
