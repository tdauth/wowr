...
function CreateNeutralHostileBuildings takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'ndmg', 5056.0, 3072.0, 270.000, 'ndmg' )
    set u = BlzCreateUnitWithSkin( p, 'ndmg', 7296.0, 896.0, 270.000, 'ndmg' )
    set u = BlzCreateUnitWithSkin( p, 'ngol', -5056.0, -3264.0, 270.000, 'ngol' )
    call SetResourceAmount( u, 28500 )
    set u = BlzCreateUnitWithSkin( p, 'ncap', -2720.0, 1248.0, 270.000, 'ncap' )
    set u = BlzCreateUnitWithSkin( p, 'ncap', -1952.0, -544.0, 270.000, 'ncap' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'ncap', -3488.0, -3616.0, 270.000, 'ncap' )
    ...
    call SetUnitState( u, UNIT_STATE_MANA, 0 )
    set u = BlzCreateUnitWithSkin( p, 'ncap', -4256.0, -4256.0, 270.000, 'ncap' )
    set life = GetUnitState( u, UNIT_STATE_LIFE )
    call SetUnitState( u, UNIT_STATE_LIFE, 0.27 * life )
    set u = BlzCreateUnitWithSkin( p, 'ncap', -4192.0, -2848.0, 270.000, 'ncap' )
    set life = GetUnitState( u, UNIT_STATE_LIFE )
    ...
    set u = BlzCreateUnitWithSkin( p, 'ncap', 6624.0, -5600.0, 270.000, 'ncap' )
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    call SetUnitState( u, UNIT_STATE_MANA, 0 )
    set u = BlzCreateUnitWithSkin( p, 'nskg', 6107.1, -3389.4, 279.960, 'nskg' )
    call SetUnitState( u, UNIT_STATE_MANA, 0 )
    set t = CreateTrigger(  )
